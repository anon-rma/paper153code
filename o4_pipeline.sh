...
python3 dataset_spliter.py --t_list ${DATADIR}/it1_s3_idxed_rewrite_dedup.jsonl ${DATADIR}/it2_s3_idxed_rewrite_dedup.jsonl ${DATADIR}/it3_s3_idxed_rewrite.jsonl ${DATADIR}/it4_s3_idxed.jsonl &&
