...
def main(out_file):
    ...
    model_prompts = {
        ...
        'Qwen3-4B-rewrite-rma-rewrite-integrated-half:latest': SFT_REWRITE_INFERENCE_QWEN3,
    }
    ...
    if test_type == 'history-llama':
        ...
        prompt_template = model_prompts[model_name]
    elif test_type == 'rewrite-qwen3-integrated':
    ...
    data_files = {                        
        ...
        'rma_base': [            
            'datasets/tc/phi-addi_rewrited/it2_NR_tc.tsv',
            'datasets/tc/phi-addi_rewrited/it2_nonNR_tc.tsv',
            'datasets/tc/phi-addi_rewrited/it3_nonNR_tc.tsv',
            'datasets/tc/phi-addi_rewrited/it4_nonNR_tc.tsv',
            'datasets/tc/phi-addi_rewrited/it5_nonNR_tc.tsv',            
        ],
        'rma_complex': [                        
            'datasets/tc/phi-addi_rewrited/it3_complex_1_tc.tsv',
            'datasets/tc/phi-addi_rewrited/it4_complex_1_tc.tsv',
            'datasets/tc/phi-addi_rewrited/it4_complex_2_tc.tsv',
            'datasets/tc/phi-addi_rewrited/it5_complex_1_tc.tsv',
            'datasets/tc/phi-addi_rewrited/it5_complex_2_tc.tsv',
            'datasets/tc/phi-addi_rewrited/it5_complex_3_tc.tsv',                    
        ],
        'droidcall': [
